...
// - SKU name
var serverfarms_appsvcplanAPIMCSBackend_skuName  = 'B1'//'P2v2' // dev - 'B1'
// - SKU tier
var serverfarms_appsvcplanAPIMCSBackend_skuTier  = 'Basic'//'PremiumV2' // dev - 'Basic'
// - SKU size
var serverfarms_appsvcplanAPIMCSBackend_skuSize  = 'B1'//'P2v2' // dev - 'B1'
// - SKU family
var serverfarms_appsvcplanAPIMCSBackend_skuFamily  = 'B'//'Pv2' // dev - 'B'
// - SKU capacity
